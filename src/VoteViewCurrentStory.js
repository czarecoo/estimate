	...
	render() {
		return (
			<div className="CurrentStory col-xs-12 col-md-8 col-lg-8 col-xl-8">
				Current Story:<br></br>
				<textarea className="" name="userStory" type="text" placeholder="There is no voting going on right now..." value={this.props.userStory} style={{ resize: "none", }} readOnly={true} />
