	...
	render() {
		return (
			<div className="VoteView">
				...
				<div className="row">
					<VoteViewCurrentStory scores={this.props.scores} currentVote={this.props.data.currentVote} userStory={this.props.data.currentStory[0] !== undefined ? this.props.data.currentStory[0].summary : ""} />
